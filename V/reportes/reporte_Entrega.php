    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link" href="../ingresarActivo.php"><i class="bx bx-user me-1"></i> Registro</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-bell me-1"></i> Reporte de Entrega</a>
                  </li>
        ...
        <a class="nav-link" onclick="exportTableToExcel('tablaresultado')" ><i class="bx bx-link-alt me-1"></i> Generar Excel</a>
                ...
                <form action="reporte_Entrega.php" id="Formfechas" name="Formfechas" method="get" accept-charset="utf-8">
                  <div class="row">
                    <div class="col">
                      ...
                      <tbody>
                        ...
                        if (empty($_GET['fecha_inicio'])) {
                          ...
                          foreach ($list as $fila) {
                            ...
                            echo "<td> 
          <a href='../ediciones/editarEntrega.php?nombre_consignatario=" . $fila['nombre_consignatario'] .
                              "&rut_consignatario=" . $fila['rut_consignatario'] .  "&cargo_consignatario=" . $fila['cargo_consignatario'] .
                          ...
                          foreach ($listado as $columna) {
                            echo "<tr>";
                            echo "<td>" . $columna['rut_consignatario'] . "</td>";
                            echo "<td>" . $columna['nombre_consignatario'] . "</td>";
                            echo "<td>" . $columna['cargo_consignatario'] . "</td>";
                            echo "<td>" . $columna['centrocosto'] . "</td>";
                            echo "<td>" . $columna['nom_activo'] . "</td>";
                            echo "<td>" . $columna['id_activo'] . "</td>";
                            echo "<td>" . $columna['fecha_entrega'] . "</td>";
                            echo "<td>" . $columna['detalle'] . "</td>";
                            echo "<td>" . $columna['rut_asigna'] . "</td>";
                            echo "<td>" . $columna['nombre_asigna'] . "</td>";
                            echo "<td>" . $columna['cargo_asigna'] . "</td>";
                             echo"<td> <a href='../ediciones/editarEntrega.php?nombre_consignatario=".$columna['nombre_consignatario']. 
                              "&rut_consignatario=".$columna['rut_consignatario'].  "&cargo_consignatario=".$columna['cargo_consignatario']. 
                              "&centrocosto=".$columna['centrocosto']."&id_activo=".$columna['id_activo']. "&nom_activo=".$columna['nom_activo']. 
                              "&fecha_entrega=".$columna['fecha_entrega'].   "&detalle=".$columna['detalle']. "&rut_asigna=".$columna['rut_asigna']. 
                              "&nombre_asigna=".$columna['nombre_asigna']. 
