...
<a href='../ediciones/editarActivo.php?activo=" . $fila['activo'] . "&marca=" . $fila['marca'] . "&modelo=" . $fila['modelo'] .
                              "&num_serie=" . $fila['num_serie'] . "&valor=" . $fila['valor'] . "&descripcion=" . $fila['descripcion'] . "&estado=" . $fila['estado'] .
                          ...
                          $listado = $data->getFechareport($fechainicio, $fechafinal);
        ...
        <a href='../ediciones/editarActivo.php?activo=" . $columna['activo'] . "&marca=" . $columna['marca'] . "&modelo=" . $columna['modelo'] .
                              "&num_serie=" . $columna['num_serie'] . "&valor=" . $columna['valor'] . "&descripcion=" . $columna['descripcion'] . "&estado=" . $columna['estado'] .
                              "&centrocosto=" . $columna['centrocosto'] . "&fecha=" . $columna['fecha'] . "&qr=" . $columna['qr'] . "&id=" . $columna['id_activo'] . "'><button type='button' class ='btn btn-'> EDITAR</a>
