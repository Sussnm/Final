...
<html
  ...
  data-assets-path="../vendors/assets/"
...
>
  <head>
    ...
    <link rel="stylesheet" href="../venndor/assets/vendor/fonts/boxicons.css" />
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Gestion de Activos</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Gestion de Activos /</span> Reporte de Activos
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="pages-account-settings-account.html"
                        ><i class="bx bx-user me-1"></i> Ingreso de Activos</a
                      >
                    </li>
                    <li class="nav-item">
                  ...
                  <form action="">
                    ...
                    <!-- Notifications -->
                    <h5 class="card-header">Reporte de Activos</h5>
                    <div class="card-body">
                      <span
                        >{{}}}}
	    ...
	    foreach ($consulta as $key => $value)
	        foreach ($value as $va ):
	            echo "<tr><td>".$va['nombre']."</td>.".$va['precio']."</td>";
	        	echo "</td>";
	        	echo "</tr>";
	        endforeach;
	    ?>
                    ...
                    <div class="card-body">
                      ...
                      <form action="javascript:void(0);">
                        <div class="row">
                          ...
                          <div class="mt-4">
                            <button type="submit" class="btn btn-primary me-2" id="listar">Ingresar</button>
