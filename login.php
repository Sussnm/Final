...
<?php
              ...
              include_once "C/loginCtrller.php";
...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="vendors/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                ...
                <img style="margin-left:0px" width="40%"     src="vendors/imagenes/logocormun.png" alt="">
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit"   id="btningresar"  name="btningresar" >Ingresar</button>
                </div>
              </form>
