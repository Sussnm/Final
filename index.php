...
>
  ...
  <body>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="V/pages-account-settings-connections.html" class="menu-link">
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Felicidades John! 🎉</h5>
                          <p class="mb-4">
                          En hora buena has accedido al portal de Activos.
                          </p>
    ...
    <!-- Page JS -->
    <script src="vendors/assets/js/dashboards-analytics.js"></script>
